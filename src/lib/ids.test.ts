...
describe("hexId", () => {
  it("accepts local seed edition ids that Zod uuid() rejects", () => {
    expect(hexId.safeParse("cccccccc-cccc-cccc-cccc-cccccccccccc").success).toBe(true);
  });
});
