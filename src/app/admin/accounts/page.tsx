...
import { AccountRowActions, CreateAccountForm } from "@/components/admin/account-forms";
...
export default async function AdminAccountsPage({
  ...
  return (
    <AdminListShell
      header={<h1 className="font-serif text-xl text-gold-700">Accounts</h1>}
      footer={
        <AdminPagination
          page={paged.page}
      ...
      toolbar={
        <>
          <CreateAccountForm editions={editions} />
